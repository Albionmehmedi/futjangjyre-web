...
<div className="flex flex-col justify-center text-white">
  ...
  <Link to="/projects/nomad" className="mt-20 md:mt-36 mb-10 md:mb-14">
  ...
  <Link to="/projects/promaja" className="mt-20 md:mt-36 mb-10 md:mb-14">
  ...
  <Link to="/projects/zanat" className="mt-20 md:mt-36 mb-10 md:mb-14">
